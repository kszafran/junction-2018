...
// WithContentType adds the contentType to the add device params
func (o *AddDeviceParams) WithContentType(contentType string) *AddDeviceParams {
	o.SetContentType(contentType)
	return o
}

// SetContentType adds the contentType to the add device params
func (o *AddDeviceParams) SetContentType(contentType string) {
	o.ContentType = contentType
}

// WithRequest adds the request to the add device params
func (o *AddDeviceParams) WithRequest(request *models.InventoryDeviceInfo) *AddDeviceParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the add device params
func (o *AddDeviceParams) SetRequest(request *models.InventoryDeviceInfo) {
	o.Request = request
}
